...
import com.reserly.platform.forms.service.ReservationFormPublicationInvalidException;
...
/** Traduce fallos del formulario a c?digos estables sin filtrar constraints ni propiedad. */
...
public class ReservationFormFieldExceptionHandler {
  ...
  @ExceptionHandler(ReservationFormPublicationInvalidException.class)
  public ResponseEntity<ReservationFormFieldErrorResponse> handlePublicationInvalid() {
    return ResponseEntity.status(HttpStatus.CONFLICT)
        .body(new ReservationFormFieldErrorResponse("RESERVATION_FORM_PUBLICATION_INVALID"));
  }
