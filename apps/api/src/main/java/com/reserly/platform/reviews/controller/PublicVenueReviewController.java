...
public interface PublicVenueReviewController {
  ...
  ResponseEntity<ReviewEligibilityResponse> checkEligibility(
      @PathVariable String venueSlug, @Valid @RequestBody ReviewEligibilityRequest request);
  ...
  ResponseEntity<PublicVenueReviewCreateResponse> create(
      @PathVariable String venueSlug, @Valid @RequestBody ReviewCreateRequest request);
}
