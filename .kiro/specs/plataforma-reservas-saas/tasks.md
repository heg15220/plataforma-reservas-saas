...
- [x] 20.21. Crear tests de relevancia, determinismo, filtros duros, fallback, explicación, aislamiento, carga, accesibilidad y experimento.
...
- [x] 21.12. Crear tests de reproducibilidad, leakage, calibración, sesgo, robustez lingüística, revocación y promoción de modelos.
...
- [x] 22.15. Crear pruebas de optimización, capacidad, frecuencia, equidad, causalidad, drift, rollback y degradación segura.
